...
Response fields should include the stable object id, current state, derived balance or contract result, and a debug trace pointing at tables such as `accounts` and `transfer_attempts`.
