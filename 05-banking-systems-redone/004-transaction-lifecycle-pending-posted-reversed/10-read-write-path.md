...
Read from `accounts, transaction_events, ledger_transactions, ledger_entries, reversals` and derive the contract answer from current state plus source history.
