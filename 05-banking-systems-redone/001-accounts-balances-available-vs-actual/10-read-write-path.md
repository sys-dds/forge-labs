...
Read from `customers, accounts, posted_balance_snapshots, account_holds, account_status_events` and derive the contract answer from current state plus source history.
