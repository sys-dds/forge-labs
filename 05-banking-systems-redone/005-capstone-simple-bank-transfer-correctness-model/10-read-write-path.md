...
Read from `customers, accounts, account_holds, transfer_requests, idempotency_keys, transfer_attempts, transaction_events, ledger_transactions, ledger_entries, reversals` and derive the contract answer from current state plus source history.
