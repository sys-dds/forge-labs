...
nightly reconciliation and payout sweep jobs use different lock keys.
...
same key for unrelated jobs, assuming lock protects rows automatically.

## Proof Assertions

first claim recorded, same job guarded, different job claim allowed.
