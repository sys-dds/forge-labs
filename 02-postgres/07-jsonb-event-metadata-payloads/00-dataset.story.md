...
listing_created, review_flagged, payment_boundary_event, moderation_event, optional metadata missing.
...
core facts buried only in JSONB, assuming identical payload shape.

## Proof Assertions

containment exact events, optional key safe, typed columns still queried.
