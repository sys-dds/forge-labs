...
Ben accepts 09:00 booking, adjacent 10:00 booking, Cy accepts overlapping window, Ada tries overlapping Ben booking.
...
app-only overlap checks, inclusive bounds, provider scope missing.

## Proof Assertions

adjacent allowed, same-provider overlap rejected, other provider allowed.
