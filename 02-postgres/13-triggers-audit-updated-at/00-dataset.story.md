...
Ben listing changes from active to paused and audit captures old/new values.
...
app-only audit responsibility, missing OLD/NEW, updated_at stale.

## Proof Assertions

updated_at moves, audit row exact old/new.
