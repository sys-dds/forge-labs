...
Alpha and beta workspaces, app_user tries cross-tenant insert and update.
...
USING without WITH CHECK, write policy missing, happy-path-only RLS tests.

## Proof Assertions

wrong-tenant read/insert/update denied, correct action allowed.
