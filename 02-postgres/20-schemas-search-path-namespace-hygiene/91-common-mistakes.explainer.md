...
The tempting shortcut is to check `public schema forever, unqualified security-sensitive names, search_path surprises` in one application handler. That misses imports, retries, admin scripts, and future services. The chapter proof forces the database behavior to be visible.
