...
Cy dispute starts open, Maya resolves it, invalid repeat resolution is attempted.
...
status update without audit, missing invalid-transition exception.

## Proof Assertions

status changes, audit row inserted, invalid transition rejected.
