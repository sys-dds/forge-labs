...
The tempting shortcut is to check `forgotten RLS, broad policy, app WHERE-only tenancy` in one application handler. That misses imports, retries, admin scripts, and future services. The chapter proof forces the database behavior to be visible.
