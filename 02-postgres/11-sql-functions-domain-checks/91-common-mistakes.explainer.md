...
The tempting shortcut is to check `vague function names, hiding expensive work, function as magic business layer` in one application handler. That misses imports, retries, admin scripts, and future services. The chapter proof forces the database behavior to be visible.
