...
Ben eligible seller, Cy lacks reviews, Noor has open dispute.
...
vague function names, hiding expensive work, function as magic business layer.

## Proof Assertions

function true/false by seller, query matches eligible set.
