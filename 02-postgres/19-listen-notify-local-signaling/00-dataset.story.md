...
Ada event insert creates notification payload with event id/type.
...
treating NOTIFY as durable queue, oversized payloads, offline consumers.

## Proof Assertions

trigger function exists, outbox payload exact.
