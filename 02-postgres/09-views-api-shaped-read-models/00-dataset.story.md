...
Ben and Cy sellers with listings, reviews, disputes, private emails.
...
SELECT star views, hidden rows counted, join inflation.

## Proof Assertions

seller card counts, hidden/deleted exclusions, email absent from view.
