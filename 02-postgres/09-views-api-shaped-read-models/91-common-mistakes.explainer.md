...
The tempting shortcut is to check `SELECT star views, hidden rows counted, join inflation` in one application handler. That misses imports, retries, admin scripts, and future services. The chapter proof forces the database behavior to be visible.
