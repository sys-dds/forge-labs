...
Ben has active bicycle-repair listing, Ben also has removed history with same slug, Cy uses same slug safely.
...
global slug uniqueness, app-only active checks, nullable uniqueness assumptions.

## Proof Assertions

duplicate active slug rejected, removed history allowed, different seller allowed, invalid price rejected.
