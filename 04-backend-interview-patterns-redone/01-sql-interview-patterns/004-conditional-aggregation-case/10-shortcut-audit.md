...
- What the learner should inspect manually: the `sellers, orders` rows, especially 103 has zero completed orders; 102 has dispute and refund; pending rows stay in denominator.
