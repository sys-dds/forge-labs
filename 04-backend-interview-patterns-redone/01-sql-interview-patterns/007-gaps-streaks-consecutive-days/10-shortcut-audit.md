...
- What the learner should inspect manually: the `users, practice_events` rows, especially 101 duplicate same day; 101 skipped day then three-day streak; 104 active no events; 105 inactive excluded.
