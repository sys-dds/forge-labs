...
INSERT INTO collections VALUES (3001,1,'Ada private saves','bookmark_folder','public'),(3002,1,'Public playlist','playlist','public');
INSERT INTO collection_members VALUES (4001,3001,4,'active',true);
INSERT INTO collection_items VALUES (5001,3001,'post',1001,10,'active'),(5002,3001,'listing',2001,5,'active'),(5003,3001,'post',1001,30,'duplicate_attempt'),(5004,3001,'listing',2002,40,'active'),(5005,3001,'post',1002,50,'active'),(5006,3002,'post',1001,10,'active');
