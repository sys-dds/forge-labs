...
- Community contracts: `communities`, `community_memberships`, `community_roles`, `community_role_assignments`, `community_permissions`, `community_join_requests`, `community_invites`, `community_bans`, `community_channels`, `channel_memberships`, `community_posts`, `community_threads`, `community_post_moderation_actions`, `community_events`, `event_rsvps`, `event_waitlist`, `event_attendance`, and `community_audit_log` explain private access, authority, channel/post visibility, moderation, RSVP capacity, waitlists, attendance, and debug traces.
