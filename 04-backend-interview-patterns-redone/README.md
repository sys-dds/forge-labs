...
Adds small product interaction modeling clinics for profiles, follows, friendships, comments, reactions, swipes, matches, feeds, notifications, activity, simple recommendations, counters, read models, visibility controls, sharing/saves, constraints, and read/write paths. This stays inside Backend Interview Patterns Redone and builds on the completed SQL clinic runner style.
