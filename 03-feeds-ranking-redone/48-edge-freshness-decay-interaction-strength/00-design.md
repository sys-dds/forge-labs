...
Edge freshness decay and interaction strength teaches edge decay and interaction strength as candidate generation before final ranking.
...
- Item: post_201, post_301, post_101, post_401
- Why it exists: expected graph candidate set for edge decay and interaction strength.
...
`[post_101, post_201, post_301, post_401, post_501, post_601]`

## Correct result from the solution

`post_201, post_301, post_101, post_401`
...
Explain edge decay and interaction strength with the exact rows in this clinic and one failure mode that would hurt the feed.
