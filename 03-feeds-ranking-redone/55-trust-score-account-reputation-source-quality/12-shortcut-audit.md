...
3. Which function contains the clinic’s core safety/integrity logic? The solution function that maps trust score account reputation source quality evidence into treatment rows.
