...
Trust score account reputation source quality teaches how safety evidence changes candidate treatment before, during, and after ranking.
...
- Item: post_101, post_401, post_701, post_601, post_201
- Why it exists: expected safe output or decision surface for trust score account reputation source quality.
...
`virality ranks Omar and Noor`

## Correct result from the solution

`post_101, post_401, post_701, post_601, post_201`
...
Explain trust score account reputation source quality with the row that proves the risk and the treatment that ranking receives.
