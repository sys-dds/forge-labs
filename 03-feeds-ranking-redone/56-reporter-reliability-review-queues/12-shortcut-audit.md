...
3. Which function contains the clinic’s core safety/integrity logic? The solution function that maps reporter reliability review queues evidence into treatment rows.
