...
Senior safety-aware feed ranking system design capstone teaches how safety evidence changes candidate treatment before, during, and after ranking.
...
- Item: post_101, post_501, post_601, post_901, post_301, post_401
- Why it exists: expected safe output or decision surface for senior safety-aware feed ranking system design capstone.
...
`score-only feed leaks spam/blocked`

## Correct result from the solution

`post_101, post_501, post_601, post_901, post_301, post_401`
...
Explain senior safety-aware feed ranking system design capstone with the row that proves the risk and the treatment that ranking receives.
