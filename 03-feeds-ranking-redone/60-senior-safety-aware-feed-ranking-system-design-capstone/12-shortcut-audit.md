...
3. Which function contains the clinic’s core safety/integrity logic? The solution function that maps senior safety-aware feed ranking system design capstone evidence into treatment rows.
