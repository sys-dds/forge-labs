...
3. Which function contains the clinic's core logic? `build_feedback_loop_report`.
...
5. Which mutation from 13-mutation-checks.md would fail? `Remove echo risk detection`.
