...
Hard filters vs downranking vs labels teaches how safety evidence changes candidate treatment before, during, and after ranking.
...
- Item: post_101, post_701, post_801, post_501, post_401, post_601
- Why it exists: expected safe output or decision surface for hard filters vs downranking vs labels.
...
`ranking-first feed leaks malware`

## Correct result from the solution

`post_101, post_701, post_801, post_501, post_401, post_601`
...
Explain hard filters vs downranking vs labels with the row that proves the risk and the treatment that ranking receives.
