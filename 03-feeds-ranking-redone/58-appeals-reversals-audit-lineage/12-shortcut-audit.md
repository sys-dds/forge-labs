...
3. Which function contains the clinic’s core safety/integrity logic? The solution function that maps appeals reversals audit lineage evidence into treatment rows.
