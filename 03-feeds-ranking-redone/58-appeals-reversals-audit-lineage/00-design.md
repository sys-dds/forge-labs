...
Appeals reversals audit lineage teaches how safety evidence changes candidate treatment before, during, and after ranking.
...
- Item: case_201 and case_501 reversals
- Why it exists: expected safe output or decision surface for appeals reversals audit lineage.
...
`appeals never reverse`

## Correct result from the solution

`case_201 and case_501 reversals`
...
Explain appeals reversals audit lineage with the row that proves the risk and the treatment that ranking receives.
