...
Safety policy decision taxonomy teaches how safety evidence changes candidate treatment before, during, and after ranking.
...
- Item: post_101, post_501, post_701, post_401
- Why it exists: expected safe output or decision surface for safety policy decision taxonomy.
...
`all posts kept as downranked`

## Correct result from the solution

`post_101, post_501, post_701, post_401`
...
Explain safety policy decision taxonomy with the row that proves the risk and the treatment that ranking receives.
