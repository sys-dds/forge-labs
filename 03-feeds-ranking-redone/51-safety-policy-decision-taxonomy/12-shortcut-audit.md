...
3. Which function contains the clinic’s core safety/integrity logic? The solution function that maps safety policy decision taxonomy evidence into treatment rows.
