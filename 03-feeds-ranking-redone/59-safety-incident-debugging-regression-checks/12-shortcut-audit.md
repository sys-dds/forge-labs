...
3. Which function contains the clinic’s core safety/integrity logic? The solution function that maps safety incident debugging regression checks evidence into treatment rows.
