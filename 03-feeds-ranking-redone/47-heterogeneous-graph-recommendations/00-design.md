...
Heterogeneous graph recommendations teaches heterogeneous source paths and node-type quotas as candidate generation before final ranking.
...
- Item: javaconf, backend_newsletter, post_101, post_201
- Why it exists: expected graph candidate set for heterogeneous source paths and node-type quotas.
...
`[post_101, post_201, spam_event]`

## Correct result from the solution

`javaconf, backend_newsletter, post_101, post_201`
...
Explain heterogeneous source paths and node-type quotas with the exact rows in this clinic and one failure mode that would hurt the feed.
