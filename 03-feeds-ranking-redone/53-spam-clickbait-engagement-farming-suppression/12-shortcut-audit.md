...
3. Which function contains the clinic’s core safety/integrity logic? The solution function that maps spam clickbait engagement farming suppression evidence into treatment rows.
