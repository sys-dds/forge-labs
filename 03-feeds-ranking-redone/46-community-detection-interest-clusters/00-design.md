...
Community detection interest clusters teaches community overlap scoring as candidate generation before final ranking.
...
- Why it exists: expected graph candidate set for community overlap scoring.
...
Explain community overlap scoring with the exact rows in this clinic and one failure mode that would hurt the feed.
