...
def run(dataset_path):
    ...
    if clinic.startswith("05-"):
        ...
        return {"final_feed": final, "eligible_ids": [101, 501, 601, 801, 901], "excluded_ids": excluded, "feature_rows": feature_rows, "reason_labels": {str(i): "feature_row" for i in final}, "debug_trace": {str(i): "feature row exposed" for i in final}}
    ...
    if clinic.startswith("08-"):
        story = [101]
        spotlight = [701, 501]
        return {"story_tray": story, "spotlight_feed": spotlight, "final_feed": story + spotlight, "eligible_ids": story + spotlight, "excluded_ids": [102,201,301,601,801], "reason_labels": {"101": "close_friend_unexpired", "701": "high_completion", "501": "language_region_match"}, "debug_trace": {"701": "completion beats raw likes after eligibility"}}
