...
Mutual friends and triangle closing teaches mutual-count triangle closing as candidate generation before final ranking.
...
- Item: maya and omar
- Why it exists: expected graph candidate set for mutual-count triangle closing.
...
Explain mutual-count triangle closing with the exact rows in this clinic and one failure mode that would hurt the feed.
