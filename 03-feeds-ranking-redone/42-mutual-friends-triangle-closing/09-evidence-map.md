...
|---|---|---|---|---|
| maya and omar | Primary kept candidate for mutual-count triangle closing. | Proof asserts it appears in graph candidates. | Trace names its graph path or score. | Drill removes its source path. |
...
| score/path row | Makes mutual-count triangle closing visible. | Proof checks semantic row fields. | Trace includes path or numeric value. | Drill erases row details. |
