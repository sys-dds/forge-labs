...
3. Which function contains the clinic's core retrieval logic? `approximate_nearest_neighbours`.
...
5. Which mutation from 13-mutation-checks.md would fail? `Scan all buckets`.
