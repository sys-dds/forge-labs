...
The broken system returned `[post_101, post_401, post_301, post_201]` because it skipped the clinic's graph rule and did not preserve useful path evidence.

The corrected system follows the graph rule for authority propagation from trusted sources, applies exclusions, and returns `post_101, post_201, post_301`.
