...
PageRank-style authority and propagation teaches authority propagation from trusted sources as candidate generation before final ranking.
...
- Item: post_101, post_201, post_301
- Why it exists: expected graph candidate set for authority propagation from trusted sources.
...
`[post_101, post_401, post_301, post_201]`

## Correct result from the solution

`post_101, post_201, post_301`
...
Explain authority propagation from trusted sources with the exact rows in this clinic and one failure mode that would hurt the feed.
