...
|---|---|---|---|---|
| post_401 | Primary kept candidate for user-item-user-item collaborative filtering. | Proof asserts it appears in graph candidates. | Trace names its graph path or score. | Drill removes its source path. |
...
| score/path row | Makes user-item-user-item collaborative filtering visible. | Proof checks semantic row fields. | Trace includes path or numeric value. | Drill erases row details. |
