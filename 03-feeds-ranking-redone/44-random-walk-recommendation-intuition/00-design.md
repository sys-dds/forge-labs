...
Random-walk recommendation intuition teaches weighted random-walk probability as candidate generation before final ranking.
...
- Item: post_101, post_301, post_501, post_401
- Why it exists: expected graph candidate set for weighted random-walk probability.
...
`[post_101, post_201, post_501, post_301, post_401]`

## Correct result from the solution

`post_101, post_301, post_501, post_401`
...
Explain weighted random-walk probability with the exact rows in this clinic and one failure mode that would hurt the feed.
