...
) THEN 1 ELSE fail_test('Ben profile counts are wrong') END AS ben_exact_counts;
...
) THEN 1 ELSE fail_test('Ada safe search returned wrong handles') END AS ada_safe_search_exact;
