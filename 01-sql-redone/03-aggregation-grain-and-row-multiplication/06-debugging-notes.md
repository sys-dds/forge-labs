...
Ben post B1 is useful because it has three likes and one comment. It proves the fix works when both child tables exist without relying on Ada's edge cases.
